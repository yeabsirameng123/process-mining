...
## config
sample = False
inputpath = 'C:\\Users\\yeabs\\Downloads\\Logs_for_Neo4J\\Logs_for_Neo4J\\BPIC15\\'


path_to_neo4j_import_directory = 'C:\\Users\\yeabs\\.Neo4jDesktop\\relate-data\\dbmss\\dbms-51d7f031-995c-417f-b57d-ffd67f88c101\\import\\'
...
def CreateBPI15(path,sample=False):
    ...
    for i in range(1,6):
        ...
        log = pd.read_csv(inputpath+fileName, keep_default_na=True, low_memory=False)
